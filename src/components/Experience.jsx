...
export default function Experience() {
  return (
    <>
      <div className="relative bg-darkBlue-900 px-10 md:px-24 py-10 rounded-t-[50px] shadow-lg text-white flex flex-col gap-5">
        ...
        <div className="absolute top-28 right-0 p-12 blur-3xl rounded-full bg-gold object-cover animate-pulse"></div>
        <div className="absolute bottom-28 left-0 p-10 blur-3xl rounded-full bg-sky-700 object-cover animate-pulse"></div>
      </div>
